...
4. **RAG task execution**
   ...
   * Parallelized financial-report ResearchTasks with Python asyncio and worker threads, cutting research-stage latency by 32% and end-to-end latency by 24% versus sequential execution.
